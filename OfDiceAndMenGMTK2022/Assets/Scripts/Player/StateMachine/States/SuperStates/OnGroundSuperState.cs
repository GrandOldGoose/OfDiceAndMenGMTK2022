...
{
    public class OnGroundSuperState : PlayerBaseState
    {
        #region Fields
        ...
        #region Constructors
        public OnGroundSuperState(Player player, PlayerData playerData, PlayerInputHandler playerInputHandler, PlayerCollisionHandler playerCollisionHandler, PlayerDamageAndAffectHandler playerDamageAndAffectHandler,
        ...
        protected void Move(float speed)
        {
            ...
            float targetVelocity = _playerInputHandler.RawMoveInput * speed;
            _rigidbody2D.velocity = new Vector2(Mathf.SmoothDamp(_rigidbody2D.velocity.x, targetVelocity, ref _velocityXRef, _playerData.OnGroundMove_MovementSmoothing),
