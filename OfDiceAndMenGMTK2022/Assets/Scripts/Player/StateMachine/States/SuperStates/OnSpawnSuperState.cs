...
{
    public class OnSpawnSuperState : PlayerBaseState
    {
        #region Fields
        ...
        #region Constructors
        public OnSpawnSuperState(Player player, PlayerData playerData, PlayerInputHandler playerInputHandler, PlayerCollisionHandler playerCollisionHandler, PlayerDamageAndAffectHandler playerDamageAndAffectHandler,
        ...
        {
            _playerDamageAndAffectHandler.CanBeDamaged = true;
            _playerDamageAndAffectHandler.IsDead = false;
        }
        #endregion
    }
}
