...
{
    public class OnDamageSuperState : PlayerBaseState
    {
        #region Fields
        ...
        #region Constructors
        public OnDamageSuperState(Player player, PlayerData playerData, PlayerInputHandler playerInputHandler, PlayerCollisionHandler playerCollisionHandler, PlayerDamageAndAffectHandler playerDamageAndAffectHandler,
