...
{
    public class OnSpawnInitialIdleState : OnSpawnSuperState
    {
        #region Fields
        ...
        #region Constructors
        public OnSpawnInitialIdleState(Player player, PlayerData playerData, PlayerInputHandler playerInputHandler, PlayerCollisionHandler playerCollisionHandler, PlayerDamageAndAffectHandler playerDamageAndAffectHandler,
        ...
        {
            _player.SetAllStatesInitial = false;
