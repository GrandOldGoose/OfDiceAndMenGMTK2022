...
{
    public class OnDeathFallState : OnDeathSuperState
    {
        #region Fields
        ...
        #region Constructors
        public OnDeathFallState(Player player, PlayerData playerData, PlayerInputHandler playerInputHandler, PlayerCollisionHandler playerCollisionHandler, PlayerDamageAndAffectHandler playerDamageAndAffectHandler,
