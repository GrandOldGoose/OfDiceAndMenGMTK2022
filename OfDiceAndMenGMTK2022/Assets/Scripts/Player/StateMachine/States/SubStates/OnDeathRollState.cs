...
{
    public class OnDeathRollState : OnDeathSuperState
    {
        #region Fields
        ...
        #region Constructors
        public OnDeathRollState(Player player, PlayerData playerData, PlayerInputHandler playerInputHandler, PlayerCollisionHandler playerCollisionHandler, PlayerDamageAndAffectHandler playerDamageAndAffectHandler,
