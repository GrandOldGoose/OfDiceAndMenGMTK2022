...
{
    public class OnSpawnFallState : OnSpawnSuperState
    {
        #region Fields
        ...
        #region Constructors
        public OnSpawnFallState(Player player, PlayerData playerData, PlayerInputHandler playerInputHandler, PlayerCollisionHandler playerCollisionHandler, PlayerDamageAndAffectHandler playerDamageAndAffectHandler,
