...
{
    public class OnDeathSpikesState : OnDeathSuperState
    {
        #region Fields
        ...
        #region Constructors
        public OnDeathSpikesState(Player player, PlayerData playerData, PlayerInputHandler playerInputHandler, PlayerCollisionHandler playerCollisionHandler, PlayerDamageAndAffectHandler playerDamageAndAffectHandler,
