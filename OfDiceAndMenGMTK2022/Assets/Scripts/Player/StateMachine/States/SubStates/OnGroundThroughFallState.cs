...
{
    public class OnGroundThroughFloorState : OnGroundSuperState
    {
        #region Fields
        ...
        #region Constructors
        public OnGroundThroughFloorState(Player player, PlayerData playerData, PlayerInputHandler playerInputHandler, PlayerCollisionHandler playerCollisionHandler, PlayerDamageAndAffectHandler playerDamageAndAffectHandler,
        ...
        {
            base.OnEnter();
            _playerCollisionHandler.DisablePlayerCollisionWithSlimFloor();
            ForceDownThroughFloor();
        }

        public override void OnExit()
        {
            base.OnExit();
            _playerCollisionHandler.EnablePlayerCollisionWithSlimFloor();
        }
        #endregion
        ...
        private void ForceDownThroughFloor()
        {
            _rigidbody2D.AddForce(new Vector2(0.0f, -_playerData.OnGroundThoughFloor_ForceDownThroughFloor));
        }
        #endregion
    }
}
